...
#     6:natural
    ...
    clf = joblib.load(os.getcwd() +"/HyrComputerVisionServer/HyrComputerVisionServer/HyrComputerVision/product/model_for_detect/pipe_nn_garbor.pkl")
